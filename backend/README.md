...
## Project Structure
    ...
    ├── testapiautosetting_127053  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127053`
...
2. Clone this repo and `cd testapiautosetting_127053`
